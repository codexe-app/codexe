...
import { Flex, Badge, Group, Text, Box, Button, ActionIcon, Card, Title, Stack, AspectRatio, Image, rem } from '@mantine/core'
    ...
    <Card shadow='xs' padding='sm' withBorder w='100%' h='240px'>
      {haspinned ? (
        ...
        <React.Fragment>
          ...
          <Stack align='start'>
            <Title order={4} mt='xs'>You have no Pinned Content</Title>
            <Text size='sm' c='dimmed'>Goto your Documents list and Pin some items</Text>
